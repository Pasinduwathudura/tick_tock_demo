...
{
    public class ActiveMonthSubmissionController : ApiController
    {
        ...
        public IHttpActionResult ActiveMonthSubmission([FromBody] approveStatus data)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand command = new SqlCommand("approveStatus", connection);
                    ...
                    string emailSubject = $"Approval Request: Full Time Sheet Submission for {monthName} {yearName} [Employee ID: {employeeNo}] - {employeeName}";
                    ...
                    using (SmtpClient client = new SmtpClient(smtpServer, smtpPort))
                    {
                        ...
                        //mail.Subject = $"Approval Request {employeeName} {monthName}";
                        ...
                        foreach (var item in trackingSheetArray)
                            ...
                            //DateTime trackingDateTime = DateTime.Parse(item["trackingDate"]);
                        ...
                        //ccMail.Subject = $"Approval Request  {employeeName} {monthName}";
